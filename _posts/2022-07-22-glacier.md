...
---
_2022 Parks Road Trip Diary: Days 27-32_
...
<!-- Jul 21, swiftcurrent pass -->
 ...
 However, we did notice that it connected to a trail that eventually led to Many Glacier Campground: the [Swiftcurrent Pass Trail](https://www.alltrails.com/trail/us/montana/swiftcurrent-pass-trail) (15.9 mi, 3800 ft elev gain). The two have nearly the same endpoint, at the Granite Park Chalet. Seeing that the Swiftcurrent Pass Trail was well-rated, we figured this would be the closest we could come to seeing what the Highline Trail was like. (And before you suggest continuing on to the Highline after Swiftcurrent Pass, _you_ try hiking 30 miles in one day.)
