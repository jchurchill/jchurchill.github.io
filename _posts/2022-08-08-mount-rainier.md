...
We couldn't tell in the dark when we arrived at almost midnight last night, but our campground was nice and woodsy, the big trees making us feel small and secluded. Still, the first priority today was to move out of here and into a park-run first-come-first-serve campground, Cougar Rock, so we could be closer to Rainier's main trailheads. Getting a spot at Cougar Rock was no problem.

At Cougar Rock, we were in the southern part of the park, less than an hour's drive from the popular area known as Paradise. Paradise has the trailhead to several great trails. We'd read that getting a parking spot at Paradise would require showing up early, but we had already used the early hours of the day to move camp. So, rather than taking the risk, we decided to spend today on a hike closer to camp: [Mildred Point via Comet Falls](https://www.alltrails.com/trail/us/washington/mildred-point-via-comet-falls--4) (7.8 mi, 2700 ft elev gain).
...
<figure>
    ...
    <figcaption>coming up on comet falls</figcaption>
</figure>
...
<figure>
    ...
    <figcaption>the view behind as you reach the top of the falls</figcaption>
</figure>
...
<figure>
    ...
    <figcaption>surrounded by bear grass</figcaption>
</figure>
...
<figure>
    ...
    <figcaption>what I called "the lorax plant"</figcaption>
</figure>
...
<figure>
    ...
    <figcaption>if mildred could do it, you can too</figcaption>
</figure>
...
<figure>
    ...
    <figcaption>at the endpoint overlooking a steep valley</figcaption>
</figure>
...
<figure>
    ...
    <figcaption>log staircase</figcaption>
</figure>
...
<figure>
    ...
    <figcaption>_insert your own caption here, i dare not try_</figcaption>
</figure>

This night we also attended our first ranger program because we heard some noise near our campsite that sounded like someone speaking through a microphone. There are a few types of ranger programs that National Parks hold, but the nighttime fireside chat (which is what this was) became our favorite. It was a lot like attending a college lecture, where the ranger gave a semi-interactive presentation on the history of the park.

I liked when he explained a bunch of the park's current challenges, and then posed questions like "how would _you_ make these tradeoffs between human tourism access and park preservation?" He linked it to the challenge of climate change overall, since it's the same problem: how can humans enjoy this place without ruining it? What are we doing currently that isn't sustainable?

Some good food for thought for tomorrows's hike.

## Day 46: Halfway up to Rainier
<!-- 8/5 skyline loop and camp muir -->

Today we woke up early enough to get a parking spot at Paradise. You can see most of the views that Paradise has to offer in one big loop, the [Skyline Loop](https://www.alltrails.com/trail/us/washington/skyline-trail), and that was our plan.
...
<figure>
    ...
    <figcaption>fancy visitor center architecture at Paradise</figcaption>
</figure>
...
<figure>
    ...
    <figcaption>myrtle falls in front of mount rainier</figcaption>
</figure>
...
<figure>
    ...
    <figcaption>a bridge straight out of alice in wonderland</figcaption>
</figure>
...
<figure>
    ...
    <figcaption>skyline, as promised</figcaption>
</figure>

We reached the high point of this hike before we were done with the ascent: coming upon two marmots who were duking it out over some presumably very important marmot matters.
...
For all seventeen climactic seconds see [here](https://photos.google.com/share/AF1QipPVD5awRC79lNkeBXnR1e2QAT5hNpN7p96xp6cTO5oBwQ88tP0ey90k-fhqqE_Vxw/photo/AF1QipM9dSDPKhu3vC1CoU3ZPbd6N2JE94tUlYCKooFp?key=QjZlelRkemZiVjhRMWswWlNsVTROclpENDFRQ0Zn).
...
<figure>
    ...
    <figcaption>panorama point, mount adams in the distance</figcaption>
</figure>
...
<figure>
    ...
    <figcaption>me, regretting having bought zinc sunscreen</figcaption>
</figure>

In researching the trails in this area I also discovered the extension of this loop which climbs up to Camp Muir: [Camp Muir via Skyline Loop Trail](https://www.alltrails.com/trail/us/washington/camp-muir-via-skyline-loop-trail) (10 mi, 4800 ft elev gain). Camp Muir is an intermediate point sitting at 10000 ft that hikers who are attempting to summit Mount Rainier will use to break up the trip into a few days. Mount Rainier's peak is above 14000 ft and requires some ice climbing skills, so even for capable people it's probably too difficult to summit in a single day.

For me, Camp Muir would be an additional four total miles (two each way) and an extra 3000 ft elevation gain off of Skyline Loop. And while the route _was_ purely snow, it wouldn't require any ice climbing. Judy heard "snow" and "3000 ft over 2 miles" and noped out, i.e., continued back to the visitor center where she and I would meet up later. I continued up to Camp Muir on my own.
...
<figure>
    ...
    <figcaption>I'm sure I'll be all right on my own</figcaption>
</figure>

This was a serious challenge for me. Imagine you're skiing, and there's a steep slope you want to do, but the lift isn't working, so you decide to walk up. That's basically what this felt like.
...
<figure>
    ...
    <figcaption>one foot in front of the other is the only way through this</figcaption>
</figure>

I think I've done enough ascents of this steepness now to say that the challenge is mostly mental. Nearly everyone else hiking this trail was a Rainier summiter, with ice axe and a heavy backpack, pace slowed by the extra weight. As a day hiker carrying much less I found a lot of motivation in being able to fly past them unburdened. 🏃‍♂️

<!-- me on the snowy hill, portrait mode -->
<figure>
...
<figure>
    ...
    <figcaption>appreciating the glaciers around me</figcaption>
</figure>
...
<figure>
    ...
    <figcaption>"you took too long so I got worried and called for your rescue" - Judy, in my head when I saw this</figcaption>
</figure>
...
<figure>
    ...
    <figcaption>statistic: only 1/4 of these people will actually summit</figcaption>
</figure>

The way back was perhaps what really made it worth reaching the top. I said it was like walking up a ski slope. How would you go down a ski slope if you didn't have skis? Walking down would just be boring.
...
<figure>
    ...
    <figcaption>example snow chute</figcaption>
</figure>
...
I found Judy at the visitor center. We restocked ice for our cooler at the visitor center's store and I made a joke about it being fresh from the glacier. The cashier seemed unamused. Back at camp, we made dinner and attended another ranger program, this time about Rainier's glaciers. A good day. 🙂

## Day 47: xcxc
<!-- 8/6, burroughs mountain -->

[Burroughs Mountain Trail](https://www.alltrails.com/trail/us/washington/burroughs-mountain-loop-trail)
...
[Wonderland Trail to Panhandle Gap](https://www.alltrails.com/trail/us/washington/wonderland-trail-to-panhandle-gap)
